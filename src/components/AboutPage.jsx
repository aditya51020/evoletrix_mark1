    ...
    <>
      ...
      <section className="section outcomes theme-light-block" style={{ paddingBlock: "96px" }}>
        <div className="shell">
          ...
          <div style={{ background: "var(--light-panel)", border: "1px solid var(--light-line)", borderRadius: "var(--radius-sm)", padding: "36px", textAlign: "center", maxWidth: "720px", margin: "0 auto" }}>
      ...
      {/* FAQ SECTION (Directly following the team testimonial light block) */}
      <FAQSection />
